...
# def load_source_channel_indices_from_reader(reader: FitsIO, exp_state: ExperimentState) -> list[int] | None:
...
#         project_metadata = {}
#     steps_meta = project_metadata.get("steps", {})
    
#     last_step = exp_state.completed_steps[-1] if exp_state.completed_steps else None
#     last_step_meta = steps_meta.get(last_step, {}) 
    
#     if "mask_source_channel_indices" in last_step_meta:
#         raw_source_channel_indices = last_step_meta.get("mask_source_channel_indices")
#     else:
