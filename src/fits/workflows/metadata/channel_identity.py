...
# def labels_to_src_indices(reader: FitsIO, chan_seg: Sequence[str], exp_state: ExperimentState) -> list[int]:
#     """
#     Resolve source channel indices for requested channel labels.
#     """
#     exported_labels, src_chan_idxs = _get_channel_identity(reader, exp_state)
...
# def src_indices_to_labels(reader: FitsIO, source_indices: Sequence[int], exp_state: ExperimentState) -> list[str]:
#     """
...
# def _get_channel_identity(reader: FitsIO, exp_state: ExperimentState) -> tuple[list[str], list[int]]:
#     exported_labels = _get_exported_labels(reader)
#     source_channel_indices = _get_source_channel_indices(reader, exp_state)
...
# def _get_source_channel_indices(reader: FitsIO, exp_state: ExperimentState) -> list[int]:
#     source_channel_indices = load_source_channel_indices_from_reader(reader, exp_state)
