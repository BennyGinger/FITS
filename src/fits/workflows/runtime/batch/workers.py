"""Map batch items using serial, thread, or process workers."""
...
def execute_items(items: Sequence[T],
                  func: Callable[[T], R],
                  *,
    ...
    """
    Execute a function over items using the requested batch worker strategy.
